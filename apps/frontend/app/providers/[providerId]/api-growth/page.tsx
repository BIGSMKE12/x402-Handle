    ...
    <>
      <TopBar
        ...
        onboarding={{
          ...
          note: 'The "API Growth" menu is designed to come alive by connecting your internal data with the HANDLE SDK. Until your data is connected, we are showing tentative demo data for reference.',
        }}
      />
